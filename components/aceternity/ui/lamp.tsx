    ...
    return (
        ...
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                ...
                <div
                    className="absolute inset-auto z-50 h-36 md:w-[28rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
                <motion.div
                    initial={{width: "8rem"}}
                    ...
                    className="absolute inset-auto z-30 h-36 w-full -translate-y-[6rem] rounded-full bg-cyan-400 blur-2xl"
                ></motion.div>
                <motion.div
                    initial={{width: "15rem"}}
            ...
            <div className="relative z-50 flex -translate-y-80 flex-col items-center justify-center w-[21.5rem] md:w-[35rem] lg:w-[45rem] xl:w-[55rem] 2xl:w-[60rem]">
                {children}
            </div>
        </div>
    );
