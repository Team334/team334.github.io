    ...
    return (
        ...
        >
            ...
            <div className="group-hover/bento:translate-x-2 transition duration-200">
                <div className="main font-bold text-neutral-600 dark:text-neutral-200 mb-2 mt-2">
                    {title}
                </div>
                <div className="secondary font-normal text-neutral-600 text-xs dark:text-neutral-300">
                    {description}
                </div>
            </div>
        </div>
